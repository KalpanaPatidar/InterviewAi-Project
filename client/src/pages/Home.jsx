          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              <span className='relative inline-block'>
                <span className='bg-green-100 text-green-600 px-5 py-1 rounded-full'>AI Intelligence
                ...
                [
                  {
                    ...
                    desc: "Scores communictaion, technical accuracy and confidence."
                  },
                  {
                    image: resumeImg,
                  ...
                  <motion.div key={index}
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      <div className=' w-full md:w-1/2 flex justify-center'>
                        <img src={item.image} alt={item.title} className='w-full h-auto object-contian max-h-64' />
                      </div>
                      <div className=' w-full md:w-1/2'>
                        <div className='bg-green-60 text-green-600 w-12 h-12 rounded-xl flex items-center justify-center mb-7'>{item.icon}</div>
