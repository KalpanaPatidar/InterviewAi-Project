...
function Step3Report({ report }) {
    ...
    else if (finalScore >= 5) {   // ✅ FIX (you repeated >=8 before)
        performanceText = "Good, but needs improvement";
        shortTagline = "Work on advanced concepts and clarity";
    }
    else {
        ...
        //skills box
                 ...
                 doc.text(`Confidence:${confidence}`,margin+10,currentY +10);
                  doc.text(`Communication:${communication}`,margin+10,currentY +18);
                   ...
                   let advice = "";
                   if(finalScore >=8){
                    advice="Excellent performance .Maintain confidence vconfidence and structure. Continue refining clarity and supporting answers with strong real-world examples.";
                   }
                    ...
                    advice="Significant improvement required,focus on structure,Practice delivering concise,confident answers with stronger supporting examples";
                   }
                   ...
                   autoTable(doc,{
                    startY:{left:margin,right:margin},
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
            ...
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                {/* RIGHT BUTTON (UNCHANGED POSITION ✅) */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                <div className="space-y-6">
                    <motion.div initial={{ opacity: 0 }}
                        ...
                        <h3 className="text-gray-500 mbp-4 sm:mb-6 text-sm sm:text-base">
                            Overall Performance
                        </h3>

                        <div className="relative w-20 h-25 sm:w-44 sm:h-44 mx-auto">
                        ...
                        <div className="mt-4">
                            ...
                            <p className="text-gray-500 text-cxs sm:text-sm mt-1">
                                {shortTagline}
                            </p>
                        </div>
                    </motion.div>
                        ...
                        <div className="space-y-6">
                            {questionWiseScore.map((q,i)=>(
                                <div key={i} className="bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border-gray-200">
                                    <div className='flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mbp-4'>
                                        <div>
                                        ...
                                        <div className='bg-green-50 border-green-200 p-4 rounded-lg'>
                                            ...
                                            <p className="text-sm text-gray-700 leading-realxed">
