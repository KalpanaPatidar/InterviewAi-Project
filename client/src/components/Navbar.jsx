          ...
          <div className='realtive'>
            ...
            {showCreditPopup && (
              <div className='absolute right-[-50px]  mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50'>
                <p className='text-sm text-gray-700 mb-4'>Need more credits to continue interview?</p>
          ...
          <div className='realtive'>
            ...
            {showUserPopup && (
              <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4  z-50 '>
                ...
                <button onClick={handleLogout} className='w-full text-left text-sm py-2  flex item-center gap-2 text-red-500'>
