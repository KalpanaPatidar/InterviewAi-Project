   ...
   const [mode, setMode] = useState("TECHNICAL");
    ...
    const handleStart = async() => {
        ...
        try{
          ...
          console.log(result.data);
          if(userData){
            dispatch(setUserData({...userData,credits:result.data.
                creditsLeft
            }))
          }
          setLoading(false)
    ...
    return (
        <motion.div
            ...
            <div className="w-full max-w-7xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
                <motion.div
                    ...
                    <p className="text-gray-700 mb-10">
                        Practice real inteview scenarios powered by AI.
                    ...
                    <div className='space-y-7 '>
                        {
                            [
                                ...
                                <motion.div key={index}
                                    ...
                                    transition={{ delay: 0.3 + index * 0.17 }}
...
<option value="HR">HR Interview</option>
                        ...
                        {!analysisDone && (
                            <motion.div
                                ...
                                {resumeFile && (<motion.button
                                    ...
                                    className="mt-4 bg-gray-900 text-white px-7 py-2 rounded-lg hover:bg-gray-800 transition">
                        ...
                        {analysisDone && (
                            <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }} className="bg-gray-70 border border-gray-200 rounded-xl p-4 space-y-4">
                                ...
                                {projects.length > 0 && (
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside text-gray-700 sapce-y-1">
                                            {projects.map((p, i) => (
                                                <li key={i}>{p}</li>
                                            ))}
                                        </ul>
